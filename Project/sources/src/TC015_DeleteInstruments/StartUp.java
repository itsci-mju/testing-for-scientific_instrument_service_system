package TC015_DeleteInstruments;
...
public class StartUp {
	...
	public static String vUrl, Vuser, Vpwd, Action;
	...
	public void main() throws  Throwable {
		...
		String xlPath_tc = "c:/Users/saram/MiniProject65/Resultsummary/TC/TC015_DeleteInstruments.xlsx";
		String xlPath_ts = "c:/Users/saram/MiniProject65/Resultsummary/TS/TS015_DeleteInstruments.xlsx";
		String xlPath_td = "c:/Users/saram/MiniProject65/Resultsummary/TD/TD015_DeleteInstruments.xlsx";
	    String xlPath ="c:/Users/saram/MiniProject65/Excel/TC015_DeleteInstruments.xlsx";
					...
					for (int j = 1; j <xTSdata.length; j++){
						if (xTCdata[i][1].equals(xTSdata[j][0])){	
	                		...
	                		if (vResult.equalsIgnoreCase("Pass")) {
	                			...
	                			if(vKeyword.contains("get_Action")) {
	                					if(vResult.contains(xTDdata[k][7])) {
		                					xTDdata[k][9] = vResult;
		                					xTDdata[k][8] = "Pass";
