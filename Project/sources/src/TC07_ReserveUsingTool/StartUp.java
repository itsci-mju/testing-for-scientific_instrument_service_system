...
public class StartUp {
	...
	public static String vUrl, Vuser, Vpwd,Type,Date,S_time,E_time,vXPath ;
	...
	public void main() throws  Throwable {
		...
		String xlPath_tc = "c:/Users/saram/MiniProject65/Resultsummary/TC/TC07_ReserveUsingTool.xlsx";
		String xlPath_ts = "c:/Users/saram/MiniProject65/Resultsummary/TS/TS07_ReserveUsingTool.xlsx";
		String xlPath_td = "c:/Users/saram/MiniProject65/Resultsummary/TD/TD07_ReserveUsingTool.xlsx";
	    String xlPath ="c:/Users/saram/MiniProject65/Excel/TC07_ReserveUsingTool.xlsx";
					...
					for (int j = 1; j <xTSdata.length; j++){
						if (xTCdata[i][1].equals(xTSdata[j][0])){	
	                		...
	                		if (vResult.equalsIgnoreCase("Pass")) {
	                			...
	                			if(vKeyword.contains("gettext_validation")) {
	                				if(vKeyword.contains("")) {
	                					xTDdata[k][11] = "Fail";
	                					xTDdata[k][12] = vResult;
	                					StartUp.xTDdata[k][13] = "Error : Not match expected result.";
	                				} 
	                				if(vResult.equalsIgnoreCase(xTDdata[k][10])) {
	                					xTDdata[k][11] = "Pass";
	                					xTDdata[k][12] = vResult;
	                					StartUp.xTDdata[k][13] = StartUp.vError;
	                				}
	                				else if((vResult.equalsIgnoreCase("") && xTDdata[k][10].equalsIgnoreCase("จองการใช้เครื่องมือวิทยาศาสตร์สำเร็จ"))) {
	                					xTDdata[k][11] = "Pass";
	                					xTDdata[k][12] = vResult;
	                					StartUp.xTDdata[k][13] = StartUp.vError;
	                				}else {
