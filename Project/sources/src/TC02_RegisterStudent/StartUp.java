...
public class StartUp {
	...
	public static String vUrl, Vuser, Vpwd, Vcpwd, VlistOc, VradioT,Vother,Vname,
	                     Vlastname,VstuID,VseDegree,Vbranch,Vfaculty,
	                     Vuniversity,VadName,VadEmail,Vemail,Vphone,xPath;
	...
	public void main() throws  Throwable {
		...
		String xlPath_tc = "c:/Users/saram/MiniProject65/Resultsummary/TC/TC02_RegisterStudent.xlsx";
		String xlPath_ts = "c:/Users/saram/MiniProject65/Resultsummary/TS/TS02_RegisterStudent.xlsx";
		String xlPath_td = "c:/Users/saram/MiniProject65/Resultsummary/TD/TD02_RegisterStudent.xlsx";
	    String xlPath ="c:/Users/saram/MiniProject65/Excel/TC02_RegisterStudent.xlsx";
		...
		for (int i = 1; i < xTCdata.length; i++) {
			if (xTCdata[i][4].equals("Y")) {
		 		...
		 		for (int k = 1; k < xTDdata.length; k++) {
	                		...
	                		if (vResult.equalsIgnoreCase("Pass")) {
	                			...
	                			if(vKeyword.contains("get_text1")) {
	                				if(vKeyword.contains("")) {
	                					xTDdata[k][23] = vResult;
	                					xTDdata[k][22] = "Fail";
	                					StartUp.xTDdata[k][24] = "Error : Not match expected result.";
	                				}
	                				
	                				if(vResult.contains(xTDdata[k][21])) {
	                					xTDdata[k][23] = vResult;
	                					xTDdata[k][22] = "Pass";
	                					StartUp.xTDdata[k][24] = StartUp.vError;
                					}
	                				
	                				if(xTDdata[k][21].equals("สมัครสมาชิกสำเร็จ") && vResult.equals("สมัครสมาชิกสำเร็จ !!!!")) {
	                					xTDdata[k][23] = vResult;
	                					xTDdata[k][22] = "Pass";
	                					StartUp.xTDdata[k][24] = StartUp.vError;
	                				}else {
					...
					System.out.println("Expected = " + StartUp.xTDdata[k][21]);
					System.out.println("Result = " + StartUp.xTDdata[k][22]);
