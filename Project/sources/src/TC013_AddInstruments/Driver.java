...
public class Driver {
	...
	public void getData(int k) {
		...
		StartUp.Sci_ID = StartUp.xTDdata[k][6];
		StartUp.Sci_Name = StartUp.xTDdata[k][7];
		StartUp.Detail = StartUp.xTDdata[k][8];
		StartUp.Staff = StartUp.xTDdata[k][9];
		StartUp.Course = StartUp.xTDdata[k][10];
		StartUp.Status = StartUp.xTDdata[k][11];
		StartUp.Photo = StartUp.xTDdata[k][12];
		StartUp.R_price = StartUp.xTDdata[k][13];
		StartUp.priceA = StartUp.xTDdata[k][14];
		StartUp.priceB = StartUp.xTDdata[k][15];
		StartUp.priceC = StartUp.xTDdata[k][16];
		StartUp.priceD = StartUp.xTDdata[k][17];
		StartUp.N_priceA = StartUp.xTDdata[k][18];
		StartUp.N_priceB = StartUp.xTDdata[k][19];
		StartUp.N_priceC = StartUp.xTDdata[k][20];
		StartUp.N_priceD = StartUp.xTDdata[k][21];
		StartUp.R_price1 = StartUp.xTDdata[k][22];
		StartUp.priceA1 = StartUp.xTDdata[k][23];
		StartUp.priceB1 = StartUp.xTDdata[k][24];
		StartUp.priceC1 = StartUp.xTDdata[k][25];
		StartUp.priceD1 = StartUp.xTDdata[k][26];
		StartUp.R_price2 = StartUp.xTDdata[k][27];
		StartUp.priceA2 = StartUp.xTDdata[k][28];
		StartUp.priceB2 = StartUp.xTDdata[k][29];
		StartUp.priceC2 = StartUp.xTDdata[k][30];
		StartUp.priceD2 = StartUp.xTDdata[k][31];
		StartUp.R_price3 = StartUp.xTDdata[k][32];
		StartUp.priceA3 = StartUp.xTDdata[k][33];
		StartUp.priceB3 = StartUp.xTDdata[k][34];
		StartUp.priceC3 = StartUp.xTDdata[k][35];
		StartUp.priceD3 = StartUp.xTDdata[k][36];
		StartUp.selectT = StartUp.xTDdata[k][37];
