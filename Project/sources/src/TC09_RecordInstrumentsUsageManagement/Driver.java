...
public class Driver {
	...
	public String keyword_executor(String vKeyword, String vIP1, String vIP2, String vIP3) throws Exception {
		...
		if (vKeyword.equals("input_DateTime")){
			util.input_DateTime(getIP(vIP1), getIP(vIP2), getIP(vIP3));
			flag = "True";
		    return "pass";
		}
		//get_text
	...
	public String getIP(String vIP){
		...
		if (vIP.equals("TotalTime")){
			vIP = StartUp.TotalTime;
		}
	...
	public void getData(int k) {
		...
		StartUp.S_date = StartUp.xTDdata[k][7];
		StartUp.S_time = StartUp.xTDdata[k][8];
		StartUp.E_date = StartUp.xTDdata[k][9];
		StartUp.E_time = StartUp.xTDdata[k][10];
		StartUp.TotalTime = StartUp.xTDdata[k][11];
