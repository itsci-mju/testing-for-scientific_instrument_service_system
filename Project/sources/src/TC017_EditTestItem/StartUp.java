package TC017_EditTestItem;

import java.text.DecimalFormat;

public class StartUp {
	
	public static String vUrl, Vuser, Vpwd, ID, Name, Experment,Minqty,TypeItem,Type_A,Type_B,Type_C,Type_D,Nextprice ;
	public static String vResult, vError, vflag,ex1; 
	...
	public void main() throws  Throwable {
		...
		String xlPath_tc = "c:/Users/saram/MiniProject65/Resultsummary/TC/TC017_EditTestItem.xlsx";
		String xlPath_ts = "c:/Users/saram/MiniProject65/Resultsummary/TS/TS017_EditTestItem.xlsx";
		String xlPath_td = "c:/Users/saram/MiniProject65/Resultsummary/TD/TD017_EditTestItem.xlsx";
	    String xlPath ="c:/Users/saram/MiniProject65/Excel/TC017_EditTestItem.xlsx";
						...
						if (xTCdata[i][1].equals(xTSdata[j][0])){	
	                		...
	                		if (vResult.equalsIgnoreCase("Pass")) {
	                			...
	                			if(vKeyword.contains("get_textAlert")) {
	                				...
	                				if(vResult.contains(ex1)) {
	                					xTDdata[k][18] = vResult;
	                					xTDdata[k][17] = "Pass";
	                					StartUp.xTDdata[k][19] = StartUp.vError;
	                				}else
	                				if(ex1.contains("แก้ไขข้อมูลการวิเคราะห์การทดสอบสำเร็จ") && vResult.contains("บันทึกสำเร็จ !!!!")) {
	                					xTDdata[k][18] = vResult;
	                					xTDdata[k][17] = "Pass";
	                					StartUp.xTDdata[k][19] = StartUp.vError;
	                				}else {
