...
public class StartUp {
	...
	public void main() throws  Throwable {
		...
		String xlPath_tc = "c:/Users/saram/MiniProject65/Resultsummary/TC/TC016_AddTestItem.xlsx";
		String xlPath_ts = "c:/Users/saram/MiniProject65/Resultsummary/TS/TS016_AddTestItem.xlsx";
		String xlPath_td = "c:/Users/saram/MiniProject65/Resultsummary/TD/TD016_AddTestItem.xlsx";
	    String xlPath ="c:/Users/saram/MiniProject65/Excel/TC016_AddTestItem.xlsx";
						...
						if (xTCdata[i][1].equals(xTSdata[j][0])){	
	                		...
	                		if (vResult.equalsIgnoreCase("Pass")) {
	                			...
	                			if(vKeyword.contains("get_textAlert")) {
	                				...
	                				if(ex1.contains("เพิ่มข้อมูลการวิเคราะห์การทดสอบสำเร็จ") && vResult.contains("บันทึกสำเร็จ !!!!")) {
	                					xTDdata[k][18] = vResult;
	                					xTDdata[k][17] = "Pass";
	                					StartUp.xTDdata[k][19] = StartUp.vError;
	                				}else {
