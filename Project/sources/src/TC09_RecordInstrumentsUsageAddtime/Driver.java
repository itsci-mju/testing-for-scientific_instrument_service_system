...
public class Driver {
	...
	public String getIP(String vIP){
		...
		if (vIP.equals("Maintennace")){
			vIP = StartUp.Maintennace;
		}
		if (vIP.equals("Total")){
			vIP = StartUp.Total;
		}
	...
	public void getData(int k) {
		...
		StartUp.Maintennace = StartUp.xTDdata[k][7];
		StartUp.Total = StartUp.xTDdata[k][8];
		StartUp.Cost = StartUp.xTDdata[k][9];
	//	StartUp.Action = StartUp.xTDdata[k][15];
